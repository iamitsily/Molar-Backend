...
$consulta = "SELECT cita.id, cita.dia, cita.hora, cita.motivo, cita.estado, cita.descripcion, cita.motivoCancelar, usuario.nombre, usuario.apellidoPaterno from cita JOIN usuario ON cita.idUsuario = usuario.matricula WHERE cita.estado = '4' AND cita.status=1";
