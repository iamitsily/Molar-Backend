...
$consulta = "SELECT cita.id, cita. dia, cita.hora, cita.motivo, medico.nombre, medico.apellidoPaterno from cita JOIN medico ON cita.idMedico=medico.matricula WHERE cita.id = '$idCita' AND cita.status=1";
