...
$consulta = "SELECT matricula, nombre, apellidoPaterno, apellidoMaterno, email, telefono, sexo, rol FROM usuario WHERE status = '1' AND rol = 2 OR rol = 3
UNION
SELECT matricula, nombre, apellidoPaterno, apellidoMaterno, email, telefono, sexo, rol FROM medico WHERE status = '1' AND rol = 2 OR rol = 3";
